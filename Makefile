# ═══════════════════════════════════════════════════════════════════════
# Next-Gen-Reco (MovieLens AI) — ergonomic Docker entry points
# ═══════════════════════════════════════════════════════════════════════
...
test: ## Run the pytest suite inside the dev image
	$(DOCKER_COMPOSE) -f docker-compose.yml -f docker-compose.dev.yml run --rm app python -m pytest tests/ -v --tb=short

lint: ## Compile-check all Python files
	$(DOCKER_COMPOSE) -f docker-compose.yml -f docker-compose.dev.yml run --rm app sh -c "python -m compileall -q app app.py && echo OK"
