...
class TestSearchWorkflow:
    ...
    def test_search_returns_paginated_results(self, mock_get, client, mock_recommender) -> None:
    ...
    @patch("app.api_server._get_recommender")
    def test_search_with_large_limit(self, mock_get, client, mock_recommender) -> None:
        mock_get.return_value = mock_recommender
    ...
    def test_search_empty_query_returns_422(self, client) -> None:
        response = client.get("/api/v1/movies/search?q=")
        assert response.status_code == 422

    @patch("app.api_server._get_recommender")
    def test_search_empty_results(self, mock_get, client, mock_recommender) -> None:
...
class TestMovieInfoWorkflow:
    ...
    @patch("app.api_server._get_recommender")
    def test_get_movie_found(self, mock_get, client, mock_recommender) -> None:
        mock_get.return_value = mock_recommender
    ...
    @patch("app.api_server._get_recommender")
    def test_get_movie_not_found(self, mock_get, client, mock_recommender) -> None:
    ...
    @patch("app.api_server._get_recommender")
    def test_recommendations_for_valid_movie(self, mock_get, client, mock_recommender) -> None:
        mock_get.return_value = mock_recommender
    ...
    @patch("app.api_server._get_recommender")
    def test_recommendations_movie_not_found(self, mock_get, client, mock_recommender) -> None:
        mock_recommender.get_movie_info.return_value = None
        mock_get.return_value = mock_recommender
...
class TestStatsWorkflow:
    ...
    @patch("app.api_server._get_recommender")
    def test_stats_returns_all_fields(self, mock_get, client, mock_recommender) -> None:
        mock_get.return_value = mock_recommender
    ...
    @patch("app.api_server._get_recommender")
    def test_stats_without_rating_count_column(self, mock_get, client) -> None:
        rec = MagicMock()
...
class TestErrorHandling:
    ...
    @patch("app.api_server._get_recommender")
    def test_recommendations_with_invalid_limit(self, mock_get, client, mock_recommender) -> None:
        mock_get.return_value = mock_recommender
        response = client.get("/api/v1/recommendations/1?n=0")
        assert response.status_code == 422  # validation error

    @patch("app.api_server._get_recommender")
    def test_search_with_negative_limit(self, mock_get, client, mock_recommender) -> None:
        mock_get.return_value = mock_recommender
...
class TestMultiEndpointWorkflow:
    ...
    @patch("app.api_server._get_recommender")
    def test_full_user_workflow(self, mock_get, client, mock_recommender) -> None:
        mock_get.return_value = mock_recommender
...
class TestConcurrentRequests:
    ...
    @patch("app.api_server._get_recommender")
    def test_sequential_search_requests(self, mock_get, client, mock_recommender) -> None:
        mock_get.return_value = mock_recommender
    ...
    @patch("app.api_server._get_recommender")
    def test_mixed_endpoint_requests(self, mock_get, client, mock_recommender) -> None:
        mock_get.return_value = mock_recommender
